      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
          <div className="navbar-nav">
            <a className="nav-link fw-bold ms-3" href="#rekomendasi">
            ...
            <a className="nav-link fw-bold ms-3" href="#kategori">
            ...
            <a className="nav-link fw-bold ms-3" href="/carikan-saya-hobi">

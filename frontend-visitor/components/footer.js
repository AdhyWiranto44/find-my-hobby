      ...
      <div className="container">
        <div className="row mb-3 py-5">
          ...
          <div className="col-6 col-md-3 mb-3 mb-md-0">
            <p className="mb-1 fw-bold">Teknologi</p>
          ...
          <div className="col-6 col-md-3 mb-3 mb-md-0">
            <p className="mb-1 fw-bold">Menu</p>
        ...
        <div className="row border-dark border-top">
          <div className="col-md text-center py-3">
            <small className="mr-2"><b>Find My Hobby</b> &#169; {new Date().getFullYear()}. Made with <a className="text-decoration-none text-danger" href={`${domain}/login`} rel="noreferrer">&#10084;</a> By <a className="link-dark" href="https://github.com/adhywiranto44" rel="noreferrer">Adhy Wiranto</a></small>
          </div>
        </div>
      </div>
    </footer>

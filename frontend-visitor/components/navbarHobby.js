    ...
    if (loading === true) {
      ...
      return (
        categories.map((category, idx) => {
          return (
            <li>
              <Link key={idx} href={`/hobbies/category/${category.slug}`}>
      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
          <div className="navbar-nav d-flex align-items-center justify-content-between">
            <div class="dropdown">
              <button class="bg-transparent border-0 dropdown-toggle nav-link fw-bold" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">

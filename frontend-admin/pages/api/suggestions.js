...
export const getSuggestions = async () => await axios.get(`${domain}/suggestions?limit=0&skip=0`, headers)
export const getSuggestionsByName = async (name = "") => await axios.get(`${domain}/suggestions?name=${name}&limit=0&skip=0`, headers)

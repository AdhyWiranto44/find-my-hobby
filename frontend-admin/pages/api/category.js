...
export const getCategories = () => axios.get(`${domain}/categories?limit=50&skip=0`)
export const getCategoriesByName = async (name = "") => await axios.get(`${domain}/categories?name=${name}&limit=50&skip=0`)
